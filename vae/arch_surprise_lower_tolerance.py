...
class VAE():
    ...
    def _build(self):
        ...
        def vae_r_loss(y_true, y_pred):
            ...
            surprise_squared = K.square(y_true - y_pred) * K.exp(K.square(y_true - K.mean(y_true, axis=0))) * 8
            r_loss = K.sum(surprise_squared, axis = [1,2,3]) # TODO mention!
            return r_loss
